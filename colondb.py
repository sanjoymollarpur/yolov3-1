...
#         )
#     plt.savefig(f"negtivedata/i{k}.jpg")
#     plt.show()
...
SIZE =448
path ="cvc-clinicDB/PNG/Original"
from PIL import Image
import glob
image_list = []
k=0
for filename in glob.glob("ETIS-LaribPolypDB/images/*.png"): #assuming gif
    print(filename)
